...
const FALLBACK_LOGOS = [
  { id: '1', client_name: 'ABC Company', bw_logo_url: '', colored_logo_url: '' },
  { id: '2', client_name: 'XYZ Corp', bw_logo_url: '', colored_logo_url: '' },
  { id: '3', client_name: 'Global Media', bw_logo_url: '', colored_logo_url: '' },
  { id: '4', client_name: 'Tech Ventures', bw_logo_url: '', colored_logo_url: '' },
  { id: '5', client_name: 'Creative Hub', bw_logo_url: '', colored_logo_url: '' },
]
...
export default function ClientLogosMarquee() {
  const [logos, setLogos] = useState<Partial<ClientLogo>[]>(FALLBACK_LOGOS)
