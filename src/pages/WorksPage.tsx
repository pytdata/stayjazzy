...
import { getPortfolioWorks } from '@/db/api'
...
const FALLBACK: PortfolioWork[] = [
  { id: '1', title: 'Corporate Event Coverage', category: 'Events', description: 'Full-day event photography and videography for a major corporate conference.', image_url: 'https://miaoda-site-img.s3cdn.medo.dev/images/KLing_e0c96d04-7630-464b-8689-5a6607210537.jpg', video_url: null, display_order: 1, is_active: true, created_at: '' },
  { id: '2', title: 'Brand Identity Design', category: 'Branding', description: 'Complete brand identity package including logo, colors, and guidelines.', image_url: 'https://miaoda-site-img.s3cdn.medo.dev/images/KLing_9b7b1ed5-bee2-4f60-90da-e9074131af83.jpg', video_url: null, display_order: 2, is_active: true, created_at: '' },
  { id: '3', title: 'Wedding Photography', category: 'Events', description: "Beautiful wedding photography capturing the couple's special moments.", image_url: 'https://miaoda-site-img.s3cdn.medo.dev/images/KLing_67fa87d7-a2ef-4b90-8a99-bd8a45c36614.jpg', video_url: null, display_order: 3, is_active: true, created_at: '' },
  { id: '4', title: 'Aerial Drone Shoot', category: 'Photography', description: 'Stunning aerial cinematography for a real estate developer.', image_url: 'https://miaoda-site-img.s3cdn.medo.dev/images/KLing_f71aaf22-25da-4676-ab92-e4921e09cfda.jpg', video_url: null, display_order: 4, is_active: true, created_at: '' },
  { id: '5', title: 'Digital Marketing Campaign', category: 'Digital', description: 'Full social media and digital marketing campaign for a local brand.', image_url: 'https://miaoda-site-img.s3cdn.medo.dev/images/KLing_af4579f0-e67d-49d5-89f3-3b2026e4942a.jpg', video_url: null, display_order: 5, is_active: true, created_at: '' },
  { id: '6', title: 'Multimedia Production', category: 'Production', description: 'TV commercial production for a national broadcast campaign.', image_url: 'https://miaoda-site-img.s3cdn.medo.dev/images/KLing_0f631029-68b9-449f-9b3a-477672772737.jpg', video_url: null, display_order: 6, is_active: true, created_at: '' },
]
...
export default function WorksPage() {
  const [works, setWorks] = useState<PortfolioWork[]>(FALLBACK)
  ...
  const categories = ['All', ...Array.from(new Set(works.map(w => w.category || 'Other').filter(Boolean)))]
